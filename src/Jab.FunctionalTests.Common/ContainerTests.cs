...
namespace JabTests
{
    public partial class ContainerTests
    {
        ...
        {
            CanUseSingletonFactoryWithParametersContainer c = new();
            var implementationWithParameter = Assert.IsType<ServiceImplementationWithParameter>(c.GetService<IService>());
            var anotherImplementation = c.GetService<IAnotherService>();
        ...
        internal partial class CanUseSingletonFactoryWithParametersContainer
        {
            public int FactoryInvocationCount;
        ...
        [Fact]
        public void CanUseTransientFactoryWithParameters()
        {
            CanUseTransientFactoryWithParametersContainer c = new();
            var implementationWithParameter = Assert.IsType<ServiceImplementationWithParameter>(c.GetService<IService>());
            var anotherImplementation = c.GetService<IAnotherService>();
        ...
        [Transient(typeof(IAnotherService), Factory = nameof(CreateMyIServiceInstance))]
        [Transient(typeof(IService2), typeof(ServiceImplementation))]
        internal partial class CanUseTransientFactoryWithParametersContainer
        {
            public int FactoryInvocationCount;
            public IAnotherService CreateMyIServiceInstance(IService2 service)
            {
        ...
        [Fact]
        public void CanUseScopedFactoryWithParameters()
        {
            CanUseScopedFactoryWithParametersContainer c = new();
            var scope1 = c.CreateScope();
        ...
        internal partial class CanUseScopedFactoryWithParametersContainer
        {
            public int FactoryInvocationCount;
            public IAnotherService CreateMyIServiceInstance(IService2 service)
            {
        ...
        {
            CanUseSingletonStaticFactoryWithParametersContainer c = new();
            var implementationWithParameter = Assert.IsType<ServiceImplementationWithParameter>(c.GetService<IService>());
            var anotherImplementation = c.GetService<IAnotherService>();

            Assert.IsType<AnotherServiceImplementation>(implementationWithParameter.AnotherService);
            Assert.Same(anotherImplementation, implementationWithParameter.AnotherService);
            Assert.Equal(1, CanUseSingletonStaticFactoryWithParametersContainer.FactoryInvocationCount);
        }
        ...
        [Singleton(typeof(IAnotherService), Factory = nameof(CreateMyIServiceInstance))]
        [Singleton(typeof(IService2), typeof(ServiceImplementation))]
        internal partial class CanUseSingletonStaticFactoryWithParametersContainer
        {
        ...
        [Fact]
        public void CanUseTransientStaticFactoryWithParameters()
        {
            CanUseTransientStaticFactoryWithParametersContainer c = new();
            var implementationWithParameter = Assert.IsType<ServiceImplementationWithParameter>(c.GetService<IService>());
            var anotherImplementation = c.GetService<IAnotherService>();

            Assert.IsType<AnotherServiceImplementation>(implementationWithParameter.AnotherService);
            Assert.NotSame(anotherImplementation, implementationWithParameter.AnotherService);
            Assert.Equal(2, CanUseTransientStaticFactoryWithParametersContainer.FactoryInvocationCount);
        }
        ...
        [Transient(typeof(IAnotherService), Factory = nameof(CreateMyIServiceInstance))]
        [Transient(typeof(IService2), typeof(ServiceImplementation))]
        internal partial class CanUseTransientStaticFactoryWithParametersContainer
        {
            public static int FactoryInvocationCount;
            public static IAnotherService CreateMyIServiceInstance(IService2 service)
            {
        ...
        [Fact]
        public void CanUseScopedStaticFactoryWithParameters()
        {
            CanUseScopedStaticFactoryWithParametersContainer c = new();
            var scope1 = c.CreateScope();
            ...
            Assert.Equal(2, CanUseScopedStaticFactoryWithParametersContainer.FactoryInvocationCount);
        }
