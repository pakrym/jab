...
internal class CodeWriter
{
    ...
    private readonly Dictionary<ISymbol, string> _typeNameCache = new(SymbolEqualityComparer.Default);
    ...
    private string ToString(bool header)
    {
        if (_position == 0)
        {
            return string.Empty;
        ...
        var builder = new StringBuilder(_position);
        ...
        builder.Append("// <auto-generated/>").Append(_newLine);
        builder.Append(_newLine);
        builder.Append("#nullable disable").Append(_newLine);
        builder.Append(_newLine);
        ...
        // Normalize newlines
        builder.Append(_builder, 0, _position).Replace(_newLine, Environment.NewLine);
