...
namespace Jab.Extensions.DependencyInjection
{
    ...
    /// </summary>
    public class ServiceProvider : ServiceProviderEngineScope, IServiceScopeFactory
    {
        ...
        public ServiceProvider() : this(Array.Empty<ServiceDescriptor>())
        {
        }

        public ServiceProvider(IEnumerable<ServiceDescriptor> serviceDescriptors) : this(serviceDescriptors, ServiceProviderOptions.Default)
        {
        }

        internal ServiceProvider(IEnumerable<ServiceDescriptor> serviceDescriptors, ServiceProviderOptions options): base(null)
        {
            _engine = GetEngine();
